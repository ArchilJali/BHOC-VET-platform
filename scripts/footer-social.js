(() => {
  ...
  style.textContent = '.bhoc-footer-socials{display:flex;align-items:center;justify-content:center;gap:10px;width:100%;margin:12px 0 0;padding-top:12px;border-top:1px solid rgba(120,110,100,.2)}.bhoc-footer-social-link{display:inline-flex;align-items:center;justify-content:center;width:34px;height:34px;border:1px solid currentColor;border-radius:9px;text-decoration:none}.bhoc-footer-social-link:hover{opacity:.82;transform:translateY(-1px)}.bhoc-footer-social-link svg{width:19px;height:19px;display:block}.bhoc-footer-social-link[data-network="linkedin"]{color:#0a66c2}.bhoc-footer-social-link[data-network="youtube"]{color:#ff0000}';
  ...
  nav.className = 'bhoc-footer-socials'; nav.setAttribute('aria-label','BHOC social media');
